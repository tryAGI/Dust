...
namespace Dust
{
    public partial interface IDatasourceViewsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.DatasourceView>> GetWByWIdSpacesBySpaceIdDataSourceViewsByDsvIdAsResponseAsync(
            string wId,
            string spaceId,
            string dsvId,
            global::Dust.AutoSDKRequestOptions? requestOptions = default,

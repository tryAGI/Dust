...
namespace Dust
{
    ...
    public sealed partial class GetWSpacesDataSourceViewsSearchResponseDocument
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWSpacesDataSourceViewsSearchResponseDocument" /> class.
        /// </summary>
        /// <param name="id">
        /// ID of the document
        /// </param>
...
#endif
        public GetWSpacesDataSourceViewsSearchResponseDocument(
            string? id,
            string? title,
            string? content,

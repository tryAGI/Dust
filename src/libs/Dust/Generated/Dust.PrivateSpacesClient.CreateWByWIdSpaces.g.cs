...
namespace Dust
{
    public partial class PrivateSpacesClient
    {
        ...
        private static readonly global::Dust.AutoSDKServer[] s_CreateWByWIdSpacesServers = new global::Dust.AutoSDKServer[]
        ...
        private static readonly global::Dust.EndPointSecurityRequirement s_CreateWByWIdSpacesSecurityRequirement0 =
        ...
        private static readonly global::Dust.EndPointSecurityRequirement[] s_CreateWByWIdSpacesSecurityRequirements =
            new global::Dust.EndPointSecurityRequirement[]
            {                s_CreateWByWIdSpacesSecurityRequirement0,
            };
        partial void PrepareCreateWByWIdSpacesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string wId,
            global::Dust.CreateWSpacesRequest request);
        partial void PrepareCreateWByWIdSpacesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string wId,
            global::Dust.CreateWSpacesRequest request);
        partial void ProcessCreateWByWIdSpacesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateWByWIdSpacesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Dust.CreateWSpacesResponse> CreateWByWIdSpacesAsync(
            string wId,
        ...
        {
            var __response = await CreateWByWIdSpacesAsResponseAsync(
                wId: wId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.CreateWSpacesResponse>> CreateWByWIdSpacesAsResponseAsync(
            string wId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateWByWIdSpacesArguments(
            ...
            var __authorizations = global::Dust.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateWByWIdSpacesSecurityRequirements,
                operationName: "CreateWByWIdSpacesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Dust.PathBuilder(
                                ...
                                servers: s_CreateWByWIdSpacesServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateWByWIdSpacesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dust.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dust.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createWByWIdSpaces",
                                methodName: "CreateWByWIdSpacesAsync",
                                pathTemplate: "$\"/api/w/{wId}/spaces\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateWByWIdSpacesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dust.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateWByWIdSpacesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dust.CreateWSpacesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dust.AutoSDKHttpResponse<global::Dust.CreateWSpacesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dust.CreateWSpacesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

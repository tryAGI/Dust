...
namespace Dust
{
    public partial class PrivateMessagesClient
    {
        ...
        private static readonly global::Dust.AutoSDKServer[] s_DeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksServers = new global::Dust.AutoSDKServer[]
        ...
        partial void PrepareDeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksArguments(
            ...
            ref string cId,
            ref string mId);
        partial void PrepareDeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string wId,
            string cId,
            string mId);
        partial void ProcessDeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Dust.DeleteWAssistantConversationsMessagesFeedbacksResponse2> DeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksAsync(
            string wId,
            string cId,
            string mId,
        ...
        {
            var __response = await DeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksAsResponseAsync(
                wId: wId,
                cId: cId,
                mId: mId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.DeleteWAssistantConversationsMessagesFeedbacksResponse2>> DeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksAsResponseAsync(
            string wId,
            string cId,
            string mId,
            global::Dust.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Dust.PathBuilder(
                                ...
                                servers: s_DeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dust.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dust.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "deleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacks",
                                methodName: "DeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dust.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dust.DeleteWAssistantConversationsMessagesFeedbacksResponse2.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dust.AutoSDKHttpResponse<global::Dust.DeleteWAssistantConversationsMessagesFeedbacksResponse2>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dust.DeleteWAssistantConversationsMessagesFeedbacksResponse2.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

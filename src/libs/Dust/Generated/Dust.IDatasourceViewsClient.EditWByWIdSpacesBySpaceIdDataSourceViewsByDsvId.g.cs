...
namespace Dust
{
    public partial interface IDatasourceViewsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.DatasourceView>> EditWByWIdSpacesBySpaceIdDataSourceViewsByDsvIdAsResponseAsync(
            string wId,
            string spaceId,
            string dsvId,

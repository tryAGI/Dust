...
namespace Dust
{
    public partial class DatasourcesClient
    {
        ...
        private static readonly global::Dust.EndPointSecurityRequirement[] s_GetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsSecurityRequirements =
            new global::Dust.EndPointSecurityRequirement[]
            {                s_GetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsSecurityRequirement0,
            };
        partial void PrepareGetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsArguments(
            ...
            ref int? limit,
            ref int? offset);
        partial void PrepareGetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            int? offset);
        partial void ProcessGetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Dust.GetWSpacesDataSourcesDocumentsResponse2> GetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsAsync(
            string wId,
            string spaceId,
            string dsId,
        ...
        {
            var __response = await GetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsAsResponseAsync(
                wId: wId,
                spaceId: spaceId,
                dsId: dsId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.GetWSpacesDataSourcesDocumentsResponse2>> GetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsAsResponseAsync(
            string wId,
            string spaceId,
            string dsId,
            global::System.Collections.Generic.IList<string>? documentIds = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsArguments(
            ...
            var __authorizations = global::Dust.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsSecurityRequirements,
                operationName: "GetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dust.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dust.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getWByWIdSpacesBySpaceIdDataSourcesByDsIdDocuments",
                                methodName: "GetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsAsync",
                                pathTemplate: "$\"/api/v1/w/{wId}/spaces/{spaceId}/data_sources/{dsId}/documents\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dust.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetWByWIdSpacesBySpaceIdDataSourcesByDsIdDocumentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dust.GetWSpacesDataSourcesDocumentsResponse2.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dust.AutoSDKHttpResponse<global::Dust.GetWSpacesDataSourcesDocumentsResponse2>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dust.GetWSpacesDataSourcesDocumentsResponse2.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

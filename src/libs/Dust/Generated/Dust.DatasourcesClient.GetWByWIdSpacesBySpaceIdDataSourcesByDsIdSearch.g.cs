...
namespace Dust
{
    public partial class DatasourcesClient
    {
        ...
        {
            var __response = await GetWByWIdSpacesBySpaceIdDataSourcesByDsIdSearchAsResponseAsync(
                wId: wId,
                spaceId: spaceId,
                dsId: dsId,
                query: query,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.GetWSpacesDataSourcesSearchResponse>> GetWByWIdSpacesBySpaceIdDataSourcesByDsIdSearchAsResponseAsync(
            string wId,
            string spaceId,
            string dsId,
            string query,
                    ...
                    await global::Dust.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dust.GetWSpacesDataSourcesSearchResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dust.AutoSDKHttpResponse<global::Dust.GetWSpacesDataSourcesSearchResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dust.GetWSpacesDataSourcesSearchResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

...
namespace Dust
{
    public partial class PrivateFilesClient
    {
        ...
        /// View or download a file. Skill attachments require read access to their associated skill. Use query parameters `version` (original, processed, public) and `action` (view, download). Downloading a Frames v2 file redirects to its source folder as a ZIP archive.
        /// </summary>
        ...
        {
            var __response = await GetWByWIdFilesByFileIdAsResponseAsync(
                wId: wId,
                fileId: fileId,
                version: version,
                action: action,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> GetWByWIdFilesByFileIdAsStreamAsync(
            string wId,
            string fileId,
            global::Dust.GetWFilesVersion? version = default,
            global::Dust.GetWFilesAction? action = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<byte[]>> GetWByWIdFilesByFileIdAsResponseAsync(
            string wId,
            string fileId,
            global::Dust.GetWFilesVersion? version = default,
            global::Dust.GetWFilesAction? action = default,

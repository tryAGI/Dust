...
namespace Dust
{
    public partial interface IConversationsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.GetWAssistantConversationsMessagesEventsResponse>> GetWByWIdAssistantConversationsByCIdMessagesByMIdEventsAsResponseAsync(
            string wId,
            string cId,
            string mId,
            string? lastEventId = default,

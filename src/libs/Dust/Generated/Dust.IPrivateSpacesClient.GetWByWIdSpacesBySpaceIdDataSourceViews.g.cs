...
namespace Dust
{
    public partial interface IPrivateSpacesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.GetWSpacesDataSourceViewsResponse3>> GetWByWIdSpacesBySpaceIdDataSourceViewsAsResponseAsync(
            string wId,
            string spaceId,
            global::Dust.GetWSpacesDataSourceViewsCategory? category = default,
            global::Dust.GetWSpacesDataSourceViewsWithDetails? withDetails = default,

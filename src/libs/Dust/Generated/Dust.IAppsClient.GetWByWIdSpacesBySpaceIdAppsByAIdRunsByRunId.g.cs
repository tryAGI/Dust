...
namespace Dust
{
    public partial interface IAppsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.GetWSpacesAppsRunsResponse>> GetWByWIdSpacesBySpaceIdAppsByAIdRunsByRunIdAsResponseAsync(
            string wId,
            string spaceId,
            string aId,
            string runId,

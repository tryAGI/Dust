...
namespace Dust
{
    public partial class MentionsClient
    {
        ...
        private static readonly global::Dust.AutoSDKServer[] s_CreateWByWIdAssistantMentionsParseServers = new global::Dust.AutoSDKServer[]
        ...
        private static readonly global::Dust.EndPointSecurityRequirement s_CreateWByWIdAssistantMentionsParseSecurityRequirement0 =
        ...
        private static readonly global::Dust.EndPointSecurityRequirement[] s_CreateWByWIdAssistantMentionsParseSecurityRequirements =
            new global::Dust.EndPointSecurityRequirement[]
            {                s_CreateWByWIdAssistantMentionsParseSecurityRequirement0,
            };
        partial void PrepareCreateWByWIdAssistantMentionsParseArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string wId,
            global::Dust.CreateWAssistantMentionsParseRequest request);
        partial void PrepareCreateWByWIdAssistantMentionsParseRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string wId,
            global::Dust.CreateWAssistantMentionsParseRequest request);
        partial void ProcessCreateWByWIdAssistantMentionsParseResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateWByWIdAssistantMentionsParseResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Dust.CreateWAssistantMentionsParseResponse> CreateWByWIdAssistantMentionsParseAsync(
            string wId,
        ...
        {
            var __response = await CreateWByWIdAssistantMentionsParseAsResponseAsync(
                wId: wId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.CreateWAssistantMentionsParseResponse>> CreateWByWIdAssistantMentionsParseAsResponseAsync(
            string wId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateWByWIdAssistantMentionsParseArguments(
            ...
            var __authorizations = global::Dust.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateWByWIdAssistantMentionsParseSecurityRequirements,
                operationName: "CreateWByWIdAssistantMentionsParseAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Dust.PathBuilder(
                                ...
                                servers: s_CreateWByWIdAssistantMentionsParseServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dust.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dust.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createWByWIdAssistantMentionsParse",
                                methodName: "CreateWByWIdAssistantMentionsParseAsync",
                                pathTemplate: "$\"/api/v1/w/{wId}/assistant/mentions/parse\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateWByWIdAssistantMentionsParseResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dust.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateWByWIdAssistantMentionsParseResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dust.CreateWAssistantMentionsParseResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dust.AutoSDKHttpResponse<global::Dust.CreateWAssistantMentionsParseResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dust.CreateWAssistantMentionsParseResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateWByWIdAssistantMentionsParseAsync(
                wId: wId,
                request: __request,
                requestOptions: requestOptions,

...
namespace Dust
{
    public partial class PrivateEventsClient
    {
        ...
        private static readonly global::Dust.AutoSDKServer[] s_GetWByWIdAssistantConversationsByCIdEventsServers = new global::Dust.AutoSDKServer[]
        ...
        private static readonly global::Dust.EndPointSecurityRequirement s_GetWByWIdAssistantConversationsByCIdEventsSecurityRequirement0 =
        ...
        private static readonly global::Dust.EndPointSecurityRequirement[] s_GetWByWIdAssistantConversationsByCIdEventsSecurityRequirements =
            new global::Dust.EndPointSecurityRequirement[]
            {                s_GetWByWIdAssistantConversationsByCIdEventsSecurityRequirement0,
            };
        partial void PrepareGetWByWIdAssistantConversationsByCIdEventsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string wId,
            ref string cId);
        partial void PrepareGetWByWIdAssistantConversationsByCIdEventsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string wId,
            string cId);
        partial void ProcessGetWByWIdAssistantConversationsByCIdEventsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Dust.PrivateConversationEvent> GetWByWIdAssistantConversationsByCIdEventsAsync(
            string wId,
            string cId,
            ...
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetWByWIdAssistantConversationsByCIdEventsArguments(
            ...
            var __authorizations = global::Dust.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetWByWIdAssistantConversationsByCIdEventsSecurityRequirements,
                operationName: "GetWByWIdAssistantConversationsByCIdEventsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::Dust.PathBuilder(
                                ...
                                servers: s_GetWByWIdAssistantConversationsByCIdEventsServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetWByWIdAssistantConversationsByCIdEventsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dust.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dust.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getWByWIdAssistantConversationsByCIdEvents",
                                methodName: "GetWByWIdAssistantConversationsByCIdEventsAsync",
                                pathTemplate: "$\"/api/w/{wId}/assistant/conversations/{cId}/events\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetWByWIdAssistantConversationsByCIdEventsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dust.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                                ...
                                .Create(__stream).EnumerateAsync(__effectiveCancellationToken))
                            {
                                ...
                                var __streamedResponse = global::Dust.PrivateConversationEvent.FromJson(__content, JsonSerializerContext) ??
                                                       throw new global::Dust.ApiException(

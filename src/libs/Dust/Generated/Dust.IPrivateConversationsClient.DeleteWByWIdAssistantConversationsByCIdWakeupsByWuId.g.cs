...
namespace Dust
{
    public partial interface IPrivateConversationsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.DeleteWAssistantConversationsWakeupsResponse>> DeleteWByWIdAssistantConversationsByCIdWakeupsByWuIdAsResponseAsync(
            string wId,
            string cId,
            string wuId,
            global::Dust.AutoSDKRequestOptions? requestOptions = default,

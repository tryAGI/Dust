...
namespace Dust
{
    public partial interface IPrivateSpacesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.PatchWSpacesDataSourceViewsResponse>> EditWByWIdSpacesBySpaceIdDataSourceViewsByDsvIdAsResponseAsync(
            string wId,
            string spaceId,
            string dsvId,

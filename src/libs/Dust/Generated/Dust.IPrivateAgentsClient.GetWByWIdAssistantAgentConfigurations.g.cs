...
namespace Dust
{
    public partial interface IPrivateAgentsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.GetWAssistantAgentConfigurationsResponse3>> GetWByWIdAssistantAgentConfigurationsAsResponseAsync(
            string wId,
            global::Dust.GetWAssistantAgentConfigurationsView2? view = default,
            int? limit = default,
            global::Dust.GetWAssistantAgentConfigurationsWithUsage? withUsage = default,

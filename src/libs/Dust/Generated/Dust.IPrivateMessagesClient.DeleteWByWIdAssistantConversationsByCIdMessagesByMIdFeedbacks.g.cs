...
namespace Dust
{
    public partial interface IPrivateMessagesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.DeleteWAssistantConversationsMessagesFeedbacksResponse2>> DeleteWByWIdAssistantConversationsByCIdMessagesByMIdFeedbacksAsResponseAsync(
            string wId,
            string cId,
            string mId,
            global::Dust.AutoSDKRequestOptions? requestOptions = default,

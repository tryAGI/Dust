...
namespace Dust
{
    public partial class DatasourcesClient
    {
        ...
        private static readonly global::Dust.AutoSDKServer[] s_GetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueServers = new global::Dust.AutoSDKServer[]
        ...
        partial void PrepareGetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueArguments(
            ...
            ref string spaceId,
            ref string dsId);
        partial void PrepareGetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string wId,
            string spaceId,
            string dsId);
        partial void ProcessGetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Dust.GetWSpacesDataSourcesCheckUpsertQueueResponse> GetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueAsync(
            string wId,
            string spaceId,
            string dsId,
        ...
        {
            var __response = await GetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueAsResponseAsync(
                wId: wId,
                spaceId: spaceId,
                dsId: dsId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.GetWSpacesDataSourcesCheckUpsertQueueResponse>> GetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueAsResponseAsync(
            string wId,
            string spaceId,
            string dsId,
            global::Dust.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Dust.PathBuilder(
                                ...
                                servers: s_GetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dust.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dust.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueue",
                                methodName: "GetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueAsync",
                                pathTemplate: "$\"/api/v1/w/{wId}/spaces/{spaceId}/data_sources/{dsId}/check_upsert_queue\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dust.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetWByWIdSpacesBySpaceIdDataSourcesByDsIdCheckUpsertQueueResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dust.GetWSpacesDataSourcesCheckUpsertQueueResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dust.AutoSDKHttpResponse<global::Dust.GetWSpacesDataSourcesCheckUpsertQueueResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dust.GetWSpacesDataSourcesCheckUpsertQueueResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

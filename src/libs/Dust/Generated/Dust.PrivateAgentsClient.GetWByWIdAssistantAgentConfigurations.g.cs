            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Dust.GetWAssistantAgentConfigurationsResponse3.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Dust.GetWAssistantAgentConfigurationsResponse3.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??

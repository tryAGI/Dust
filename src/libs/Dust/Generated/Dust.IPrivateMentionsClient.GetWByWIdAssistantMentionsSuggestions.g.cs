...
namespace Dust
{
    public partial interface IPrivateMentionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.GetWAssistantMentionsSuggestionsResponse2>> GetWByWIdAssistantMentionsSuggestionsAsResponseAsync(
            string wId,
            string? query = default,
            global::Dust.GetWAssistantMentionsSuggestionsSelect? select = default,
            global::Dust.GetWAssistantMentionsSuggestionsCurrent? current = default,

...
namespace Dust
{
    public partial interface IDatasourcesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.Table>> GetWByWIdSpacesBySpaceIdDataSourcesByDsIdTablesByTIdAsResponseAsync(
            string wId,
            string spaceId,
            string dsId,
            string tId,

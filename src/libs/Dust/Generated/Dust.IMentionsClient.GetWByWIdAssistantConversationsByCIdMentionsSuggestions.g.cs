...
namespace Dust
{
    public partial interface IMentionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dust.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dust.AutoSDKHttpResponse<global::Dust.GetWAssistantConversationsMentionsSuggestionsResponse>> GetWByWIdAssistantConversationsByCIdMentionsSuggestionsAsResponseAsync(
            string wId,
            string cId,
            string query,
            global::System.Collections.Generic.IList<global::Dust.GetWAssistantConversationsMentionsSuggestionsSelectItem>? select = default,
